...
"QScrollArea > QWidget > QWidget { background: transparent; }")
        ...
        self.action_new_file_pattern = QAction(Form)
        self.action_new_file_pattern.setObjectName(u"action_new_file_pattern")
        self.action_new_file_pattern.setIcon(icon)
...
#endif // QT_CONFIG(tooltip)
        self.action_new_file_pattern.setText(QCoreApplication.translate("Form", u"New file pattern...", None))
#if QT_CONFIG(tooltip)
        self.action_new_file_pattern.setToolTip(QCoreApplication.translate("Form", u"<html><head/><body><p>Add file pattern.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
