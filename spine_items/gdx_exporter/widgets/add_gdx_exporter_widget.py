...
"""
Widget shown to user when a new GdxExporter item is created.
...
class AddGdxExporterWidget(AddProjectItemWidget):
    ...
    def __init__(self, toolbox, x, y, spec=""):
        ...
        """
        super().__init__(toolbox, x, y, GdxExporter, spec=spec)
