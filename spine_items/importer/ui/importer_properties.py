...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.cancel_on_error_checkBox.setToolTip(
            QCoreApplication.translate(
                "Form", u"If there are any errors when trying to import data cancel the whole import.", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.cancel_on_error_checkBox.setText(QCoreApplication.translate("Form", u"Cancel import on error", None))
        # if QT_CONFIG(tooltip)
        self.pushButton_import_editor.setToolTip(
            QCoreApplication.translate(
                "Form", u"<html><head/><body><p>Open selected file in Import Editor</p></body></html>", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.pushButton_import_editor.setText(QCoreApplication.translate("Form", u"Import Editor...", None))
        # if QT_CONFIG(tooltip)
        self.toolButton_open_dir.setToolTip(
            QCoreApplication.translate(
                "Form",
                u"<html><head/><body><p>Open this Importer's project directory in file browser</p></body></html>",
                None,
            )
        )
